...
export const answers = [
 ...
 {id:'visa',patterns:['visa','sponsorship','work permit','work authorisation','work authorization','right to work','h1b','h-1b','passport','abroad','overseas','international relocation','outside india','uk','united kingdom','europe','european','usa','united states','america','australia','work abroad','move abroad','relocate abroad'],answer:`${profile.relocation}. For roles in India no sponsorship is required; for the UK, EU, US or Australia he would need visa sponsorship. Within India he is open to ${profile.openTo}.`,href:'/#contact'},
 ...
 // 'halcyon' and 'opus' belong to the parent, so a question about the Halcyon
 ...
 {id:'education',patterns:['education','college','university','degree','cdac','diploma','qualification','qualifications','highest qualification','graduation','btech','b.e','bachelor','bachelors','engineering degree','academics'],answer:'Alex completed a PG Diploma in Advanced Computing at Brookfield Institute, Thiruvananthapuram in 2022, a BE in Civil Engineering at Riverside College of Engineering in 2021, and a Diploma in Civil Engineering in 2018.',href:'/resume-sample.pdf'},
 ...
 {id:'location',patterns:['location','located','based','residence','resident','address','home town','hometown','commute','dombivli','thane','pin code','which city','mumbai','where does he live','where does alex live','where is he based','where is he located','where does he stay','current city'],answer:`Alex lives in ${profile.residence}, and is based in the Austin area, Maharashtra, India. Within India he is open to ${profile.openTo}. ${profile.relocation}.`,href:profile.linkedin},
