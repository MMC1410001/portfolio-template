...
export const profile = {
 ...
 relocation: 'Holds a valid passport; open to sponsored relocation to the UK, EU, US or Australia',
};
...
export const privateWork = [
 ...
 {id:'onefinance',name:'Nimbus Finance product visibility portal',aliases:['nimbus finance','1 finance','product visibility portal','organisation visibility'],description:'Brief and research work supporting a product visibility portal. Internal requirements, analytics, and delivery material are private.'},
...
export const skills = [
 ...
 {name:'Delivery',items:['Git / GitHub','Docker','AWS EC2','CI/CD']},
];
